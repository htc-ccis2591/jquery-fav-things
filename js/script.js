$(function() {
    ...
    /////////////////////////////////////////
        ...
        var fav2HTML = '<div class="fav_number" id="fav2">'+
                        ...
                        '<div class="imgdiv2 hideClass"><img class="centeredImg" src="images/family.png" ></div>'+
        ...
        var fav3HTML = '<div class="fav_number" id="fav3">'+
                        ...
                        '<div class="imgdiv2 hideClass"><img class="centeredImg" src="images/newzealand.png" ></div>'+
        ...
        var fav4HTML = '<div class="fav_number" id="fav4">'+
                        ...
                        '<div class="imgdiv2 hideClass"><img class="centeredImg" src="images/baseball.png" ></div>'+
        ...
        var fav5HTML = '<div class="fav_number" id="fav5">'+
                        ...
                        '<div class="imgdiv2 hideClass"><img class="centeredImg" src="images/hpBooks.jpg" ></div>'+
        ...
        var fav6HTML = '<div class="fav_number" id="fav6">'+
                        ...
                        '<div class="imgdiv2 hideClass"><img class="centeredImg" src="images/bacon.jpg" ></div>'+
                ...
                $favItems.on('click', function () {   
                    ...
                    if (slideshow.hasClass('showClass')){
                        ...
                        slideshowInterval = setInterval( function() {
                            ...
                            $(slideshow).children('img:first').show().fadeTo(0, 0);
                            fadeInImg(slideshow);
                        }, 3000 );
